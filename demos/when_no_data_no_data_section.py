...
def when_no_data_no_data_section_sample():
    ...
    CAUTION: Edit values of 'host' and 'port' to those in your environment.
     """
    print('running when no data no data section sample')
    jrxml_filename = '../demos/jrxml/when_no_data_no_data_section.jrxml'  # input jrxml filename
    output_filename = '../demos/output/when_no_data_no_data_section.pdf'  # output pdf filename
...
if __name__ == '__main__':
    when_no_data_no_data_section_sample()
