...
def when_no_data_no_pages_sample(jrxml_filename = './jrxml/when_no_data_no_pages.jrxml',
                                 output_filename = './output/when_no_data_no_pages.pdf'):
    """
    When no data, no pages sample.

    What to do when datasource is specified but the query return is specified in 'No Pages' on a report.
    ...
    # jrxml_filename = './jrxml/when_no_data_no_pages.jrxml'  # input jrxml filename
    # output_filename = './output/when_no_data_no_pages.pdf'  # output pdf filename
