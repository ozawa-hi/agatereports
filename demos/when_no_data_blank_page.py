...
def when_no_data_blank_page_sample():
    ...
    CAUTION: Edit values of 'host' and 'port' to those in your environment.
     """
    print('running when no data blank page sample')
    jrxml_filename = '../demos/jrxml/when_no_data_blank_page.jrxml'  # input jrxml filename
    output_filename = '../demos/output/when_no_data_blank_page.pdf'  # output pdf filename
