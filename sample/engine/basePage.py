...
class BaseClass:
    ...
    """
    def __init__(self, jrxml_filename, output_filename, data_source, fonts=None, report_type='pdf'):
    ...
    def generate_pdf(self):
        reportGenerator.generate_report(input_filename=self.jrxml_filename, output_filename=self.output_filename,
